        ...
        if (isset($_POST['nota2']) && is_numeric($_POST['nota2'])) {
            $nota2 = $_POST['nota2'];
        } else {
            $nota2 = 0;
            $aviso = 'Insira uma nota valida';
        }

        if (isset($_POST['nota3']) && is_numeric($_POST['nota3'])) {
            $nota3 = $_POST['nota3'];
        } else {
            $nota3 = 0;
            $aviso = 'Insira uma nota valida';
        ...
        if (isset($_POST['nota4']) && is_numeric($_POST['nota4'])) {
            $nota4 = $_POST['nota4'];
        } else {
            $nota4 = 0;
            $aviso = 'Insira uma nota valida';
        ...
        <body>
            ...
            <div>
                ...
                <span>Status:
                    <?php if ($resultado) :
                        echo $retorno = 'Aluno aprovado'; ?>
                    <?php else :
                        echo $retorno = 'Aluno reprovado';
                     endif; ?>
                </span>
            </div>
        </body>
